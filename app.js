...
function estabelecimentoMatch(e, termo, modalidade, cidade, especialidade) {
...
function render() {
  ...
  const resultado = ESTABELECIMENTOS.filter(e => estabelecimentoMatch(e, termo, modalidade, cidade, especialidade));
